...
<cfparam name="attributes.format" default="pdfEmail">
<cfset attributes.formDataId = 301877>
...
<cfif CompareNoCase(attributes.format,"pdfEmail") eq 0>
    ...
    <cfmail to="andress@3rdmill.com.au" from="helpdesk@3rdmill.com.au" 
        subject="Yamaha Marine Insurance NZ (#pdfResult.insured_name#) (Cover Bound - Ref:#attributes.formDataId#)" type="HTML">
