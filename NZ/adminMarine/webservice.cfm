...
<cfif isOkToProceed>
    <cftry>
        ...
        <cfset ATTRIBUTES.theXmlContent = XmlParse(trim(ATTRIBUTES.xmlRequest),false)>
        <cfset ATTRIBUTES.xmlWSLogId = createWebServiceLog(ip_addr="#CGI.REMOTE_ADDR#"
            ,marine_company_id="#CONST_MARINE_COMP_ID#"
            ,external_id=""
            ,requester_id=""
            ...
            <cfelse>
                ...
                <cfif isOkToProceed>
                    <cfif CompareNoCase(ATTRIBUTES.act,"DoUser") eq 0>
                        <!--- IGNORE ROLE CHECK --->
                    <cfelse>
                        <cfif ListFindNoCase(StructFind(ATTRIBUTES.thirdgenDetails,"userRoleIDs"),CONST_MARINE_ROLEID) lte 0>
