    ...
    <td valign="top" style="width:60%" >
        <form id="quotesSearchForm" action="" name="quotesSearchForm" method="get" >
            ...
            <tr>
                ...
                <td><a href="?sV=&sPS=01-JAN-2018&sPE=&act=quoteAdmin&qs=&"><b>Show all Treenodes</b></a></td>
            </tr>
            <!--- </cfif> --->
            <tr>
            ...
            <input type="hidden" name="act" id="act" value="quoteAdmin">
...
<cfabort> --->
    ...
    <cfloop query="getDataSection">
        ...
        select xml_data from thirdgen_form_data where form_data_id = #getDataSection.form_data_id#
         ...
         <cfset QuoteFor = StructFind(marineQuoteStruct,ListFirst(CONST_MQ_FirstName_FID,"|")) & " " & StructFind(marineQuoteStruct,ListFirst(CONST_MQ_Surname_FID,"|"))>
         ...
         <cfset x = querySetCell(queryResult, ListGetAt(theHeader,5),NumberFormat(StructFind(marineQuoteStruct,ListFirst(CONST_MQ_InsuredValue_FID,"|")),".99"))>
          
          
         <cfset model = StructFind(marineQuoteStruct,ListFirst(CONST_MQ_BoatMake_FID,"|")) & " " & getDataSection.type_display & " / " & getDataSection.const_display 
         & " / " & getDataSection.speed_display>
         ...
         <cfset x = querySetCell(queryResult, ListGetAt(theHeader,10),getDataSection.extRefId)>
    ...
    <cfset tmpFileName = "rpt_ymi_nz_quotes_#DateFormat(now(),'YYYYMMDD')##TimeFormat(now(),'HHMMSS')#.csv">
