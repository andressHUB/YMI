...
<cfset attributes.formDataId = 265021>
...
<cfif CompareNoCase(attributes.format,"pdfEmail") eq 0>
    ...
    <cfmail to="andress@3rdmill.com.au"  from="#application.THIRDGENPLUS_SYSTEM_EMAIL_ADDRESS#" replyto="#stateContactEmail#" 
