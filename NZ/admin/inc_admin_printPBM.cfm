...
<!--- <cfmail to="andress@3rdmill.com.au" from="helpdesk@3rdmill.com.au" type="html" subject="Debug BikeQuoteDetails">
	<cfdump var="#BikeQuoteDetails.CB_CoverCommDate#"><br>
    <!--- <cfoutput>#dateDiff('n','18/06/2019',lsParseDateTime(BikeQuoteDetails.CB_CoverCommDate,'dd/mm/yyyy'))#</cfoutput> --->
    <!--- <cfoutput>#dateTimeFormat("18/06/2019","dd/mm/yyyy")#</cfoutput><br>
    <cfoutput>#lsDateFormat(BikeQuoteDetails.CB_CoverCommDate)#</cfoutput><br> --->
    
    
    <cfset newPBTMFromDate = CreateDate(2019,6,18)>
    
    
    <cfoutput>newPBTMFromDate #newPBTMFromDate#</cfoutput><br>
    
    
    <cfif BikeQuoteDetails.CB_CoverCommDate neq "">
    
        <cfset CoverCommDate = LSParseDateTime(BikeQuoteDetails.CB_CoverCommDate)>
        <cfoutput>CoverCommDate #CoverCommDate#</cfoutput><br>
    
    
        <cfif CoverCommDate ge newPBTMFromDate>
            <cfoutput>NEW</cfoutput>
        <cfelse>
            <cfoutput>OLD</cfoutput>
        </cfif>
    <cfelse>
          <cfoutput>NEW</cfoutput>  
    </cfif>        
...
<cfset PBTMTemplateName = "YMINZ_Motorcycle_PayByMonth_form">
...
<cfif BikeQuoteDetails.CB_CoverCommDate neq "">
    ...
    <cfif CoverCommDate ge newPBTMFromDate>
            <cfset PBTMTemplateName = PBTMTemplateName>    
    <cfelse>
            <cfset PBTMTemplateName = PBTMTemplateName & "_pr_2019">    
    </cfif>
...
<!--- <cfmail to="andress@3rdmill.com.au" from="helpdesk@3rdmill.com.au" type="html" subject="Debug BikeQuoteDetails">
    <cfoutput>PBTMTemplateName [#PBTMTemplateName#]</cfoutput>
</cfmail> --->


<!--- <cfset thePDFTemplate = "#application.BASE_FOLDER#admin\pdf_template\YMINZ_Motorcycle_PayByMonth_form.pdf"> --->
<cfset thePDFTemplate = "#application.BASE_FOLDER#admin\pdf_template\#PBTMTemplateName#.pdf">
...
<cfif FileExists("#appFormsLoc##PDF_PBM_filename#")>
    ...
    <cfelseif CompareNoCase(attributes.format,"pdfEmail") eq 0>
        <cfoutput>
        <cfmail to="#emailTo#" from="#application.THIRDGENPLUS_SYSTEM_EMAIL_ADDRESS#" subject="Yamaha Motorcycle Insurance NZ Pay By Month" type="HTML">
            Hi #emailUser#, <br/>
