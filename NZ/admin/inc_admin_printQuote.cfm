...
<cfset PDF_summary_filename = "YMINZ_summary_"& StructFind(thePDFVar,"reference_id") &".pdf">
...
<cfif not StructKeyExists(pdfResult,"summary_premium") or StructFind(pdfResult,"summary_premium") eq 0 or StructFind(pdfResult,"summary_premium") eq "" >
    <cflocation addtoken="No" url="#application.THIRDGENPLUS_ROOT#/html/myquotes.cfm?fdid=#attributes.formDataId#">
</cfif>
...
<cfelseif ListFind(pdfResult.opt_coverType,CONST_BQ_QuoteOffRoad_ListItemID) gt 0>
    <cfset PDF_PDS_filename = ListAppend(PDF_PDS_filename,"YMINZ_Motorcycle_PDS.pdf")>
<cfelseif ListFind(pdfResult.opt_coverType,CONST_BQ_QuoteTPD_ListItemID) gt 0>
    <cfset PDF_PDS_filename = ListAppend(PDF_PDS_filename,"YMINZ_Motorcycle_PDS.pdf")>
<cfelseif ListFind(pdfResult.opt_coverType,CONST_BQ_QuoteTPO_ListItemID) gt 0>
    <cfset PDF_PDS_filename = ListAppend(PDF_PDS_filename,"YMINZ_Motorcycle_PDS.pdf")>
</cfif>
...
<cfif CompareNoCase(attributes.format,"pdfEmail") eq 0 or CompareNoCase(attributes.format,"pdfEmailOnly") eq 0>
    ...
    <cfmail to="#emailTo#" from="#application.THIRDGENPLUS_SYSTEM_EMAIL_ADDRESS#" replyto="#emailTo#" 
        subject="Yamaha Motorcycle Insurance NZ (Quote - Ref:#attributes.formDataId#)" type="HTML">
...
<!--- <cfif CompareNoCase(format,"pdfPrint") eq 0 >
